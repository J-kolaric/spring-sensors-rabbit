...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/J-kolaric/spring-sensors-rabbit.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "tapjko.azurecr.io/supply-chain/spring-sensors-publisher",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/J...(truncated), main->main]
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->tapjko.azurecr.io/su...(truncated)]
